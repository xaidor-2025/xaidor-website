          ...
          {programs.map((program, idx) => (
            <div
              ...
              className={`bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow relative ${
                program.popular ? "ring-2 ring-[#EC5D50]" : ""
              }`}
            >
              {program.online ? (
              ...
              <a
                href="#register"
                className={`block w-full py-3 rounded-lg font-medium text-center transition-colors bg-[#EC5D50] text-white hover:bg-[#E04336] border-2 border-[#EC5D50] hover:bg-[#FEF3F2]"
                }`}
              >
                Enroll Now
              </a>
